...
import type { FoodFilterState } from '../components/ingredient/ModalIngredient';
...
export const fetchFoodsApi = async (payload: FilterFoodPayload) => {
    const query = new URLSearchParams();
